...
fn try_parse_collection_burn_successful() {
	ParaA::execute_with(|| {
		...
		testpara::System::assert_has_event(testpara::RuntimeEvent::NFTs(
			pallet_uniques::Event::Destroyed { collection: 0 },
		));
	});
}
...
fn try_parse_nft_burn_successful() {
	ParaA::execute_with(|| {
		...
		testpara::System::assert_has_event(testpara::RuntimeEvent::NFTs(
			pallet_uniques::Event::Burned { collection: 0, item: 0, owner: ALICE },
		));
	});
}
...
fn try_parse_nft_metadata_successful() {
	ParaA::execute_with(|| {
		...
		testpara::System::assert_has_event(testpara::RuntimeEvent::NFTs(
			pallet_uniques::Event::MetadataSet {
				collection: 0,
				item: 0,
				data: BoundedVec::new(),
				is_frozen: false,
...
fn try_parse_nft_owner_successful() {
	ParaA::execute_with(|| {
		...
		testpara::System::assert_has_event(testpara::RuntimeEvent::NFTs(
			pallet_uniques::Event::Transferred { collection: 0, item: 0, from: ALICE, to: BOB },
		));
	});
}
